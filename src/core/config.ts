...
export const DEFAULT_SIMULATION_CONFIG: Readonly<SimulationConfig> = {
  ...
  population: { initial: 80, initialPredators: 8, max: 3000 },
  ...
  lifecycle: { maxAge: 90, minReproductionAge: 8, longevityCost: 1, offspringEnergyShare: 0.3, reproductionCostPerSize: 10 },
  ...
  predation: { bodyEnergyPerSize: 100, efficiency: 0.7, stomachShare: 1, catchChance: 0.5, attackCooldown: 1, fleeDuration: 2,
    scentRadius: 40, shareRadius: 12, immigrationInterval: 60 },
